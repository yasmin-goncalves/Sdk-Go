...
func (endpoints endpoints) CreateSubscriptionOneStep(planID int, body map[string]interface{}) (string, error) {
	params := map[string]string{ "id": strconv.Itoa(planID) }
	return endpoints.requester.request("/plan/:id/subscription/one-step", "POST", params, body)
}

func (endpoints endpoints) CreateSubscriptionOneStepLink(planID int, body map[string]interface{}) (string, error) {
	params := map[string]string{ "id": strconv.Itoa(planID) }
...
func (endpoints endpoints) ResendSubscriptionCharge(chargeID int, body map[string]interface{}) (string, error) {
	params := map[string]string{ "id": strconv.Itoa(chargeID) }
...
func (endpoints endpoints) ResendChargeLink(chargeID int) (string, error) {
	params := map[string]string{ "id": strconv.Itoa(chargeID) }
	return endpoints.requester.request("/charge/:id/link/resend", "POST", params, nil)
}
...
func (endpoints endpoints) OneStepLink(body map[string]interface{}) (string, error) {
...
func (endpoints endpoints) ofListParticipants() (string, error) {
	return endpoints.requester.request("/participantes/:nome", "GET", nil, nil)
}

func (endpoints endpoints) payListPayments(inicio string, fim string) (string, error) {
	return endpoints.requester.request("pagamento/resumo", "GET", nil, nil)
}