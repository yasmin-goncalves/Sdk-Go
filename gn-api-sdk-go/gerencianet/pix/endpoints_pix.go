...
func (endpoints endpoints) ListDueChargesId(txid string) (string, error) {
	params := map[string]string{ "txid": (txid) }
	return endpoints.requester.request("/v2/cobv/:txid", "PATCH", params, nil)
}
...
func (endpoints endpoints) ListDueCharges() (string, error) {
	return endpoints.requester.request("/v2/cobv/", "GET", nil, nil)
}
